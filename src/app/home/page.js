...
export default function Home() {
  ...
  const hCtaClass = isAzula ? "bg-[#00d4ff] text-[#020508] hover:bg-[#37ddff]" : isAlerik ? "bg-[#c9a84c] text-[#050505] hover:bg-[#e0bc5a]" : isCherry ? "bg-rose-600 text-white hover:bg-rose-700" : isLight ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-cyan-500 text-slate-950 hover:bg-cyan-400";
  const hCard = isLight ? "border-slate-300 bg-white/90 shadow-sm" : isAzula ? "border-[#00b4ff]/25 bg-[#020f23]/85" : isAlerik ? "border-[#c9a84c]/30 bg-[#0d0d0d]/85" : "border-white/12 bg-slate-900/55";
  const hSoft = isLight ? "border-slate-300 bg-white/85" : isAzula ? "border-[#00b4ff]/20 bg-[#020c1b]/70" : isAlerik ? "border-[#c9a84c]/20 bg-[#0a0a0a]/70" : "border-white/10 bg-white/5";
  const hMuted = isLight ? "text-slate-600" : isAzula ? "text-[#a8d4f0]/80" : isAlerik ? "text-[#c4b48a]/80" : "text-white/75";
  const hAccent = isCherry ? "text-rose-700" : isAzula ? "text-[#4fc3f7]" : isAlerik ? "text-[#c9a84c]" : isLight ? "text-slate-500" : "text-cyan-200/80";
  const hHonest = isCherry ? "border-rose-300 bg-rose-50 text-rose-800" : isAzula ? "border-[#00d4ff]/25 bg-[#00d4ff]/10 text-[#b8e8ff]" : isAlerik ? "border-[#c9a84c]/25 bg-[#c9a84c]/10 text-[#e8d7ac]" : isLight ? "border-amber-300 bg-amber-50 text-amber-800" : "border-cyan-400/25 bg-cyan-500/10 text-cyan-200";
            ...
            <div className="space-y-6 mb-6">
              ...
              <div className={`rounded-2xl border backdrop-blur-md p-6 md:p-8 shadow-[0_14px_40px_-22px_rgba(15,23,42,0.9)] home-reveal ${hCard}`}>
                <div className="grid grid-cols-1 lg:grid-cols-[1.35fr_0.9fr] gap-6 items-start">
                  <div>
                    ...
                    <p className={`mt-3 text-xl md:text-2xl font-medium ${isLight ? "text-slate-700" : isAzula ? "text-[#c8e8ff]" : isAlerik ? "text-[#e8d7ac]" : "text-white/90"}`}>It&apos;s time everyday investors can earn too.</p>
                  ...
                  <div className={`rounded-2xl border p-4 md:p-5 ${hSoft}`}>
                    <h3 className={`text-sm font-semibold uppercase tracking-wide ${isLight ? "text-slate-700" : isAzula ? "text-[#4fc3f7]" : isAlerik ? "text-[#c9a84c]" : "text-cyan-100/90"}`}>Market Overview</h3>
              ...
              <div className={`rounded-2xl border backdrop-blur-md p-6 md:p-8 shadow-[0_14px_40px_-22px_rgba(15,23,42,0.9)] home-reveal ${hCard}`}>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 mt-1">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg font-bold ${isLight ? "bg-slate-900 text-white" : isAzula ? "bg-[#00d4ff]/20 text-[#4fc3f7] border border-[#00d4ff]/30" : isAlerik ? "bg-[#c9a84c]/20 text-[#c9a84c] border border-[#c9a84c]/30" : "bg-cyan-500/20 text-cyan-300 border border-cyan-500/30"}`}>Y</div>
                  </div>
                  <div>
              ...
              <div className={`rounded-2xl border backdrop-blur-md p-6 md:p-10 shadow-[0_14px_40px_-22px_rgba(15,23,42,0.9)] home-reveal ${hCard}`}>
                ...
                <h2 style={{fontFamily: '"Cormorant Garamond", "Georgia", serif'}} className={`mt-2 text-4xl md:text-6xl leading-[0.98] ${isLight ? "text-slate-900" : "text-white"}`}>
                  ...
                  <em className={`${isAzula ? "text-[#4fc3f7]" : isAlerik ? "text-[#c9a84c]" : isLight ? "text-amber-700" : "text-yellow-300"} italic`}>gambling with extra steps.</em>
                </h2>
              ...
              <div className={`rounded-2xl border backdrop-blur-md p-6 md:p-10 shadow-[0_14px_40px_-22px_rgba(15,23,42,0.9)] home-reveal ${hCard}`}>
                ...
                <h2 style={{fontFamily: '"Cormorant Garamond", "Georgia", serif'}} className={`mt-2 text-4xl md:text-6xl leading-[0.98] mb-6 ${isLight ? "text-slate-900" : "text-white"}`}>
                  Four steps from{" "}
                  <em className={`${isAzula ? "text-[#4fc3f7]" : isAlerik ? "text-[#c9a84c]" : isLight ? "text-amber-700" : "text-yellow-300"} italic`}>curious</em>{" "}
                  to confident.
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                  {[{title:"Learn the Basics",text:"Start in Market School. Know what you are trading before you trade it."},{title:"Explore the Research",text:"Click the tabs. Read the executive briefs. Understand the market context."},{title:"Make Your Own Trades",text:"Use simulated capital. Research first. Then decide."},{title:"Build Real Instinct",text:"Weeks of practice build pattern recognition. Experience becomes confidence."},{title:"Ask ASTRA",text:"Use ASTRA to analyze trades and understand signals."}].map((step, idx) => (
                    <div key={step.title} className={`rounded-xl border p-4 text-center ${hSoft}`}>
                      <div className={`mx-auto mb-3 h-10 w-10 rounded-full border flex items-center justify-center text-[11px] tracking-[0.08em] ${isLight ? "border-slate-400 text-slate-600" : isAzula ? "border-[#00d4ff]/60 text-[#4fc3f7]" : isAlerik ? "border-[#c9a84c]/60 text-[#c9a84c]" : "border-white/30 text-white/70"}`}>{String(idx + 1).padStart(2, "0")}</div>
              ...
              <div className={`rounded-2xl border backdrop-blur-md p-6 md:p-10 shadow-[0_14px_40px_-22px_rgba(15,23,42,0.9)] home-reveal ${hCard}`}>
                ...
                <h2 style={{fontFamily: '"Cormorant Garamond", "Georgia", serif'}} className={`mt-2 text-4xl md:text-6xl leading-[0.98] mb-3 ${isLight ? "text-slate-900" : "text-white"}`}>
                  ...
                  <em className={`${isAzula ? "text-[#4fc3f7]" : isAlerik ? "text-[#c9a84c]" : isLight ? "text-amber-700" : "text-yellow-300"} italic`}>explain themselves.</em>
                </h2>
              ...
              <div className={`rounded-2xl border backdrop-blur-md p-6 md:p-10 shadow-[0_14px_40px_-22px_rgba(15,23,42,0.9)] home-reveal ${hCard}`}>
                ...
                <h2 style={{fontFamily: '"Cormorant Garamond", "Georgia", serif'}} className={`mt-2 text-4xl md:text-6xl leading-[0.98] ${isLight ? "text-slate-900" : "text-white"}`}>
                  ...
                  <em className={`${isAzula ? "text-[#4fc3f7]" : isAlerik ? "text-[#c9a84c]" : isLight ? "text-amber-700" : "text-yellow-300"} italic`}>tired of the gap.</em>
                </h2>
