# Morning Plan (Paper/Research Only): 20260217T205739Z_0d7bdc2b

This is a probabilistic research note. It does not guarantee profits and is not trading advice.

- Created (UTC): `2026-02-17T20:57:39.828447Z`
...
- Label: `risk_off`
- Confidence: `1.00` (method: `hmmlearn`)

## Ranked Picks (Top)

| Rank | Ticker | Score | Vol | Mom(63) | Corr(SPY) | p-value | FDR | Reason |
|---:|---|---:|---:|---:|---:|---:|:---:|---|
| 1 | GLD | 0.014 | 0.011 | 0.032 | 1.000 | 1.17e-08 | Y | score=0.014 (z_mom=-1.04, z_trend=0.37, z_risk=0.76, z_dd=0.98); p(one-sided)=1.17e-08 FDR=Y |
| 2 | TLT | -0.178 | 0.011 | 0.032 | 1.000 | 1.17e-08 | Y | score=-0.178 (z_mom=-0.31, z_trend=1.00, z_risk=-1.41, z_dd=-1.37); p(one-sided)=1.17e-08 FDR=Y |
...
- Sharpe breakdown: recent=`11.261067741091175` baseline=`11.259195960734425` drift=`False`
...
- Config sha256: `fc671e65da5ca200b070cad4390e92dbd0c0246520df784cf9fa3ae6c955ec93`
